...
public class CommandSign implements Listener {
	 ...
	 * 
	 * @param block
	 *            The Sign block in the world
	 * @param commands
	 *            The List of commands to execute when the player clicks the
	 *            sign
	 * @param plugin
	 *            Your plugin, to register the listener
	 */
	 ...
	 *            The Sign block in the world
	 * @param command
	 *            The command to execute when the player clicks the sign
	 * @param plugin
	 *            Your plugin, to register the listener
	 */
	...
	/**
	 * This void will be runned when Bukkit calls a PlayerInteractEvent It will
	 * check if this block is clicked and then execute the commands.
	 * 
	 * @param e
	 *            The event
	 */
	...
	public void onClick(PlayerInteractEvent e) {
		if (e.getAction() == Action.RIGHT_CLICK_BLOCK) {
			if (e.getClickedBlock().getType() == Material.SIGN_POST
				...
				if (LocationUtils.isSame(b.getLocation(), e.getClickedBlock()
						.getLocation())) {
